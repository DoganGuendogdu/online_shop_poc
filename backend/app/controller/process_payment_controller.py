...
from ..service.process_payment_service import ApplePayStrategy
from ..service.process_payment_service import MasterCardStrategy
from ..service.process_payment_service import PayPalStrategy
from ..service.process_payment_service import PaySafeStrategy
from ..service.process_payment_service import Payment
...
class ProcessPaymentController:
    ...
    def get_PayPal_payment_details(self, paypal_user_name: str, paypal_password: SecretStr):
        ...
        self.__payment.set_payment_method(PayPalStrategy(paypal_model))
        return self.__payment.get_payment_details()
    ...
    def get_master_card_payment_details(self, credit_card_number: int, expiration_date: datetime, cvc_number: int,
        ...
        self.__payment.set_payment_method(MasterCardStrategy(credit_card_model))
        return self.__payment.get_payment_details()

    def get_PaySafe_payment_details(self, paysafe_code: int):
        paysafe_model = PaySafeModel(paysafe_code=paysafe_code)
        self.__payment.set_payment_method(PaySafeStrategy(paysafe_model))
        return self.__payment.get_payment_details()
    ...
    def get_ApplePay_payment_details(self, apple_id: EmailStr, apple_id_password: SecretStr):
        ...
        self.__payment.set_payment_method(ApplePayStrategy(apple_pay_model))
        return self.__payment.get_payment_details()
